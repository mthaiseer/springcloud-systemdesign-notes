...
```mermaid
flowchart TD
    CodeforcesRoot["Codeforces 151A Soft Drinking"]
    CodeforcesRoot --> CodeforcesTopic["Topic: Ceiling Division"]
    CodeforcesRoot --> CodeforcesConcepts["Concepts: minimum among limiting resources integer divisio"]
    CodeforcesRoot --> CodeforcesGoal["Goal: Convert the statement into a known math pattern"]
    CodeforcesRoot --> CodeforcesHint["Hint: Compute each resource capacity and take minimum"]
    CodeforcesRoot --> CodeforcesComplexity["Complexity: O 1"]
```
...
```mermaid
flowchart TD
    CodeforcesRoot["Codeforces 919A Supermarket"]
    CodeforcesRoot --> CodeforcesTopic["Topic: Ceiling Division"]
    CodeforcesRoot --> CodeforcesConcepts["Concepts: ratio comparison price per unit minimum value"]
    CodeforcesRoot --> CodeforcesGoal["Goal: Convert the statement into a known math pattern"]
    CodeforcesRoot --> CodeforcesHint["Hint: Track minimum double ratio"]
    CodeforcesRoot --> CodeforcesComplexity["Complexity: O n"]
```
...
```mermaid
flowchart TD
    CodeforcesRoot["Codeforces 913A Modular Exponentiation"]
    CodeforcesRoot --> CodeforcesTopic["Topic: Modulo and Cycles"]
    CodeforcesRoot --> CodeforcesConcepts["Concepts: modulo powers of two overflow avoidance"]
    CodeforcesRoot --> CodeforcesGoal["Goal: Convert the statement into a known math pattern"]
    CodeforcesRoot --> CodeforcesHint["Hint: If n is large enough directly print m"]
    CodeforcesRoot --> CodeforcesComplexity["Complexity: O 1"]
```
...
```mermaid
flowchart TD
    CSESIncreaRoot["CSES Increasing Array"]
    CSESIncreaRoot --> CSESIncreaTopic["Topic: Modulo and Cycles"]
    CSESIncreaRoot --> CSESIncreaConcepts["Concepts: monotonic invariant operation count"]
    CSESIncreaRoot --> CSESIncreaGoal["Goal: Convert the statement into a known math pattern"]
    CSESIncreaRoot --> CSESIncreaHint["Hint: Track previous maximum"]
    CSESIncreaRoot --> CSESIncreaComplexity["Complexity: O n"]
```
...
```mermaid
flowchart TD
    CSESExponeRoot["CSES Exponentiation"]
    CSESExponeRoot --> CSESExponeTopic["Topic: Binary Exponentiation"]
    CSESExponeRoot --> CSESExponeConcepts["Concepts: binary exponentiation modulo many queries"]
    CSESExponeRoot --> CSESExponeGoal["Goal: Convert the statement into a known math pattern"]
    CSESExponeRoot --> CSESExponeHint["Hint: Use modPow a b MOD"]
    CSESExponeRoot --> CSESExponeComplexity["Complexity: O log b per query"]
```
...
```mermaid
flowchart TD
    CSESExponeRoot["CSES Exponentiation II"]
    CSESExponeRoot --> CSESExponeTopic["Topic: Binary Exponentiation"]
    CSESExponeRoot --> CSESExponeConcepts["Concepts: Fermat reduction nested exponent modular power"]
    CSESExponeRoot --> CSESExponeGoal["Goal: Convert the statement into a known math pattern"]
    CSESExponeRoot --> CSESExponeHint["Hint: Use modPow twice"]
    CSESExponeRoot --> CSESExponeComplexity["Complexity: O log c plus log MOD"]
```
...
```mermaid
flowchart TD
    CSESBinomiRoot["CSES Binomial Coefficients"]
    CSESBinomiRoot --> CSESBinomiTopic["Topic: Modular Arithmetic"]
    CSESBinomiRoot --> CSESBinomiConcepts["Concepts: factorials inverse factorials nCr modulo prime"]
    CSESBinomiRoot --> CSESBinomiGoal["Goal: Convert the statement into a known math pattern"]
    CSESBinomiRoot --> CSESBinomiHint["Hint: Precompute factorial and inverse factorial"]
    CSESBinomiRoot --> CSESBinomiComplexity["Complexity: O maxN log MOD plus q"]
```
...
```mermaid
flowchart TD
    CSESDistriRoot["CSES Distributing Apples"]
    CSESDistriRoot --> CSESDistriTopic["Topic: Modular Arithmetic"]
    CSESDistriRoot --> CSESDistriConcepts["Concepts: stars and bars nCr modulo prime"]
    CSESDistriRoot --> CSESDistriGoal["Goal: Convert the statement into a known math pattern"]
    CSESDistriRoot --> CSESDistriHint["Hint: Answer nCr n m 1 n 1"]
    CSESDistriRoot --> CSESDistriComplexity["Complexity: O maxN log MOD plus 1"]
```
...
```mermaid
flowchart TD
    CSESCommonRoot["CSES Common Divisors"]
    CSESCommonRoot --> CSESCommonTopic["Topic: GCD and LCM"]
    CSESCommonRoot --> CSESCommonConcepts["Concepts: divisors frequency counting largest common divis"]
    CSESCommonRoot --> CSESCommonGoal["Goal: Convert the statement into a known math pattern"]
    CSESCommonRoot --> CSESCommonHint["Hint: Use frequency array and multiples loop"]
    CSESCommonRoot --> CSESCommonComplexity["Complexity: O maxA log maxA"]
```
...
```mermaid
flowchart TD
    CodeforcesRoot["Codeforces 1458A Row GCD"]
    CodeforcesRoot --> CodeforcesTopic["Topic: GCD and LCM"]
    CodeforcesRoot --> CodeforcesConcepts["Concepts: gcd transformation difference invariant"]
    CodeforcesRoot --> CodeforcesGoal["Goal: Convert the statement into a known math pattern"]
    CodeforcesRoot --> CodeforcesHint["Hint: Compute gcd of differences once"]
    CodeforcesRoot --> CodeforcesComplexity["Complexity: O n log A plus q log A"]
```
...
```mermaid
flowchart TD
    CSESCountiRoot["CSES Counting Divisors"]
    CSESCountiRoot --> CSESCountiTopic["Topic: Primes and Divisors"]
    CSESCountiRoot --> CSESCountiConcepts["Concepts: prime factorization divisor count formula precom"]
    CSESCountiRoot --> CSESCountiGoal["Goal: Convert the statement into a known math pattern"]
    CSESCountiRoot --> CSESCountiHint["Hint: Build SPF then apply divisor formula"]
    CSESCountiRoot --> CSESCountiComplexity["Complexity: O maxA log log maxA plus q log A"]
```
...
```mermaid
flowchart TD
    CodeforcesRoot["Codeforces 546D Soldier and Number Game"]
    CodeforcesRoot --> CodeforcesTopic["Topic: Primes and Divisors"]
    CodeforcesRoot --> CodeforcesConcepts["Concepts: prime factor count prefix SPF range query"]
    CodeforcesRoot --> CodeforcesGoal["Goal: Convert the statement into a known math pattern"]
    CodeforcesRoot --> CodeforcesHint["Hint: Precompute factor counts and prefix"]
    CodeforcesRoot --> CodeforcesComplexity["Complexity: O maxN log log maxN plus q"]
```
...
```mermaid
flowchart TD
    CSESStaticRoot["CSES Static Range Sum Queries"]
    CSESStaticRoot --> CSESStaticTopic["Topic: Prefix Sum"]
    CSESStaticRoot --> CSESStaticConcepts["Concepts: prefix sum range query O one answer"]
    CSESStaticRoot --> CSESStaticGoal["Goal: Convert the statement into a known math pattern"]
    CSESStaticRoot --> CSESStaticHint["Hint: Build prefix once"]
    CSESStaticRoot --> CSESStaticComplexity["Complexity: O n plus q"]
```
...
```mermaid
flowchart TD
    CSESForestRoot["CSES Forest Queries"]
    CSESForestRoot --> CSESForestTopic["Topic: Prefix Sum"]
    CSESForestRoot --> CSESForestConcepts["Concepts: 2D prefix sum rectangle query"]
    CSESForestRoot --> CSESForestGoal["Goal: Convert the statement into a known math pattern"]
    CSESForestRoot --> CSESForestHint["Hint: Use one based 2D prefix"]
    CSESForestRoot --> CSESForestComplexity["Complexity: O n squared plus q"]
```
...
```mermaid
flowchart TD
    CSESNumberRoot["CSES Number Spiral"]
    CSESNumberRoot --> CSESNumberTopic["Topic: Sequences"]
    CSESNumberRoot --> CSESNumberConcepts["Concepts: pattern by layer parity formula"]
    CSESNumberRoot --> CSESNumberGoal["Goal: Convert the statement into a known math pattern"]
    CSESNumberRoot --> CSESNumberHint["Hint: Use max coordinate and parity"]
    CSESNumberRoot --> CSESNumberComplexity["Complexity: O 1 per query"]
```
...
```mermaid
flowchart TD
    CSESWeirdARoot["CSES Weird Algorithm"]
    CSESWeirdARoot --> CSESWeirdATopic["Topic: Sequences"]
    CSESWeirdARoot --> CSESWeirdAConcepts["Concepts: sequence simulation parity transition"]
    CSESWeirdARoot --> CSESWeirdAGoal["Goal: Convert the statement into a known math pattern"]
    CSESWeirdARoot --> CSESWeirdAHint["Hint: Use long long"]
    CSESWeirdARoot --> CSESWeirdAComplexity["Complexity: Depends on sequence length"]
```
...
```mermaid
flowchart TD
    CSESMissinRoot["CSES Missing Number"]
    CSESMissinRoot --> CSESMissinTopic["Topic: Summation Formulas"]
    CSESMissinRoot --> CSESMissinConcepts["Concepts: sum formula missing value"]
    CSESMissinRoot --> CSESMissinGoal["Goal: Convert the statement into a known math pattern"]
    CSESMissinRoot --> CSESMissinHint["Hint: Use sum formula"]
    CSESMissinRoot --> CSESMissinComplexity["Complexity: O n"]
```
...
```mermaid
flowchart TD
    CSESTwoSetRoot["CSES Two Sets"]
    CSESTwoSetRoot --> CSESTwoSetTopic["Topic: Summation Formulas"]
    CSESTwoSetRoot --> CSESTwoSetConcepts["Concepts: sum parity constructive partition"]
    CSESTwoSetRoot --> CSESTwoSetGoal["Goal: Convert the statement into a known math pattern"]
    CSESTwoSetRoot --> CSESTwoSetHint["Hint: Check parity then construct greedily"]
    CSESTwoSetRoot --> CSESTwoSetComplexity["Complexity: O n"]
```
...
```mermaid
flowchart TD
    CSESCreatiRoot["CSES Creating Strings"]
    CSESCreatiRoot --> CSESCreatiTopic["Topic: Counting"]
    CSESCreatiRoot --> CSESCreatiConcepts["Concepts: permutations with duplicate characters"]
    CSESCreatiRoot --> CSESCreatiGoal["Goal: Convert the statement into a known math pattern"]
    CSESCreatiRoot --> CSESCreatiHint["Hint: Sort then use next permutation"]
    CSESCreatiRoot --> CSESCreatiComplexity["Complexity: O k times n"]
```
...
flowchart TD
    CSESDistriRoot["CSES Distributing Apples"]
    CSESDistriRoot --> CSESDistriTopic["Topic: Counting"]
    CSESDistriRoot --> CSESDistriConcepts["Concepts: stars and bars modular combination"]
    CSESDistriRoot --> CSESDistriGoal["Goal: Convert the statement into a known math pattern"]
    CSESDistriRoot --> CSESDistriHint["Hint: Use modular nCr"]
    CSESDistriRoot --> CSESDistriComplexity["Complexity: O maxN log MOD"]
```
...
```mermaid
flowchart TD
    CSESGrayCoRoot["CSES Gray Code"]
    CSESGrayCoRoot --> CSESGrayCoTopic["Topic: Logs Bits and Halving"]
    CSESGrayCoRoot --> CSESGrayCoConcepts["Concepts: bits xor binary representation"]
    CSESGrayCoRoot --> CSESGrayCoGoal["Goal: Convert the statement into a known math pattern"]
    CSESGrayCoRoot --> CSESGrayCoHint["Hint: Use gray i i 1"]
    CSESGrayCoRoot --> CSESGrayCoComplexity["Complexity: O n times 2 n"]
```
...
```mermaid
flowchart TD
    CSESSubsetRoot["CSES Subset Sums"]
    CSESSubsetRoot --> CSESSubsetTopic["Topic: Logs Bits and Halving"]
    CSESSubsetRoot --> CSESSubsetConcepts["Concepts: xor basis bit linear algebra"]
    CSESSubsetRoot --> CSESSubsetGoal["Goal: Convert the statement into a known math pattern"]
    CSESSubsetRoot --> CSESSubsetHint["Hint: Use xor basis"]
    CSESSubsetRoot --> CSESSubsetComplexity["Complexity: O n log A"]
```
...
```mermaid
flowchart TD
    CSESAppleDRoot["CSES Apple Division"]
    CSESAppleDRoot --> CSESAppleDTopic["Topic: Algebra"]
    CSESAppleDRoot --> CSESAppleDConcepts["Concepts: minimize difference total sum relation subset se"]
    CSESAppleDRoot --> CSESAppleDGoal["Goal: Convert the statement into a known math pattern"]
    CSESAppleDRoot --> CSESAppleDHint["Hint: Use bitmask subset enumeration"]
    CSESAppleDRoot --> CSESAppleDComplexity["Complexity: O 2 n times n or O 2 n"]
```
...
```mermaid
flowchart TD
    CodeforcesRoot["Codeforces 1360D Buying Shovels"]
    CodeforcesRoot --> CodeforcesTopic["Topic: Algebra"]
    CodeforcesRoot --> CodeforcesConcepts["Concepts: factor choice minimize packages divisor constrai"]
    CodeforcesRoot --> CodeforcesGoal["Goal: Convert the statement into a known math pattern"]
    CodeforcesRoot --> CodeforcesHint["Hint: Scan divisors up to sqrt n"]
    CodeforcesRoot --> CodeforcesComplexity["Complexity: O sqrt n per test"]
```
...
flowchart TD
    CSESNumberRoot["CSES Number Spiral"]
    CSESNumberRoot --> CSESNumberTopic["Topic: Quadratic Formula"]
    CSESNumberRoot --> CSESNumberConcepts["Concepts: square layers parity coordinate formula"]
    CSESNumberRoot --> CSESNumberGoal["Goal: Convert the statement into a known math pattern"]
    CSESNumberRoot --> CSESNumberHint["Hint: Use layer equals max row col"]
    CSESNumberRoot --> CSESNumberComplexity["Complexity: O 1"]
```
...
```mermaid
flowchart TD
    CodeforcesRoot["Codeforces 1352C K th Not Divisible by n"]
    CodeforcesRoot --> CodeforcesTopic["Topic: Quadratic Formula"]
    CodeforcesRoot --> CodeforcesConcepts["Concepts: counting formula inverse reasoning"]
    CodeforcesRoot --> CodeforcesGoal["Goal: Convert the statement into a known math pattern"]
    CodeforcesRoot --> CodeforcesHint["Hint: Use derived formula"]
    CodeforcesRoot --> CodeforcesComplexity["Complexity: O 1"]
```
...
```mermaid
flowchart TD
    CSESPointLRoot["CSES Point Location Test"]
    CSESPointLRoot --> CSESPointLTopic["Topic: Geometry"]
    CSESPointLRoot --> CSESPointLConcepts["Concepts: cross product orientation"]
    CSESPointLRoot --> CSESPointLGoal["Goal: Convert the statement into a known math pattern"]
    CSESPointLRoot --> CSESPointLHint["Hint: Use integer cross product"]
    CSESPointLRoot --> CSESPointLComplexity["Complexity: O 1 per query"]
```
...
```mermaid
flowchart TD
    CSESPolygoRoot["CSES Polygon Area"]
    CSESPolygoRoot --> CSESPolygoTopic["Topic: Geometry"]
    CSESPolygoRoot --> CSESPolygoConcepts["Concepts: shoelace formula cross product sum"]
    CSESPolygoRoot --> CSESPolygoGoal["Goal: Convert the statement into a known math pattern"]
    CSESPolygoRoot --> CSESPolygoHint["Hint: Use long long cross sum"]
    CSESPolygoRoot --> CSESPolygoComplexity["Complexity: O n"]
```
...
```mermaid
flowchart TD
    CSESApartmRoot["CSES Apartments"]
    CSESApartmRoot --> CSESApartmTopic["Topic: Big O"]
    CSESApartmRoot --> CSESApartmConcepts["Concepts: sorting two pointers complexity reduction"]
    CSESApartmRoot --> CSESApartmGoal["Goal: Convert the statement into a known math pattern"]
    CSESApartmRoot --> CSESApartmHint["Hint: Sort then two pointers"]
    CSESApartmRoot --> CSESApartmComplexity["Complexity: O n log n plus m log m"]
```
...
```mermaid
flowchart TD
    CSESFerrisRoot["CSES Ferris Wheel"]
    CSESFerrisRoot --> CSESFerrisTopic["Topic: Big O"]
    CSESFerrisRoot --> CSESFerrisConcepts["Concepts: greedy sorting two pointers"]
    CSESFerrisRoot --> CSESFerrisGoal["Goal: Convert the statement into a known math pattern"]
    CSESFerrisRoot --> CSESFerrisHint["Hint: Sort and use two pointers"]
    CSESFerrisRoot --> CSESFerrisComplexity["Complexity: O n log n"]
```
...
```mermaid
flowchart TD
    CSESFactorRoot["CSES Factory Machines"]
    CSESFactorRoot --> CSESFactorTopic["Topic: Binary Search on Answer"]
    CSESFactorRoot --> CSESFactorConcepts["Concepts: binary search monotonic predicate production cou"]
    CSESFactorRoot --> CSESFactorGoal["Goal: Convert the statement into a known math pattern"]
    CSESFactorRoot --> CSESFactorHint["Hint: Binary search minimum time"]
    CSESFactorRoot --> CSESFactorComplexity["Complexity: O n log answer"]
```
...
```mermaid
flowchart TD
    CSESIncreaRoot["CSES Increasing Array Queries"]
    CSESIncreaRoot --> CSESIncreaTopic["Topic: Difference Array"]
    CSESIncreaRoot --> CSESIncreaConcepts["Concepts: prefix style thinking monotonic stack contributi"]
    CSESIncreaRoot --> CSESIncreaGoal["Goal: Convert the statement into a known math pattern"]
    CSESIncreaRoot --> CSESIncreaHint["Hint: Study after basic prefix sums"]
    CSESIncreaRoot --> CSESIncreaComplexity["Complexity: Advanced"]
```
...
```mermaid
flowchart TD
    CSESCountiRoot["CSES Counting Coprime Pairs"]
    CSESCountiRoot --> CSESCountiTopic["Topic: Inclusion Exclusion"]
    CSESCountiRoot --> CSESCountiConcepts["Concepts: mobius inclusion exclusion coprime counting"]
    CSESCountiRoot --> CSESCountiGoal["Goal: Convert the statement into a known math pattern"]
    CSESCountiRoot --> CSESCountiHint["Hint: Use divisor counts and Mobius"]
    CSESCountiRoot --> CSESCountiComplexity["Complexity: O maxA log maxA"]
```
...
```mermaid
flowchart TD
    CSESNimGamRoot["CSES Nim Game I"]
    CSESNimGamRoot --> CSESNimGamTopic["Topic: Game Theory"]
    CSESNimGamRoot --> CSESNimGamConcepts["Concepts: xor invariant impartial games"]
    CSESNimGamRoot --> CSESNimGamGoal["Goal: Convert the statement into a known math pattern"]
    CSESNimGamRoot --> CSESNimGamHint["Hint: Xor all piles"]
    CSESNimGamRoot --> CSESNimGamComplexity["Complexity: O n"]
```
...
```mermaid
flowchart TD
    CodeforcesRoot["Codeforces 1096F Inversion Expectation"]
    CodeforcesRoot --> CodeforcesTopic["Topic: Expected Value"]
    CodeforcesRoot --> CodeforcesConcepts["Concepts: linearity of expectation inversions modular prob"]
    CodeforcesRoot --> CodeforcesGoal["Goal: Convert the statement into a known math pattern"]
    CodeforcesRoot --> CodeforcesHint["Hint: Use linearity of expectation"]
    CodeforcesRoot --> CodeforcesComplexity["Complexity: Advanced"]
```
