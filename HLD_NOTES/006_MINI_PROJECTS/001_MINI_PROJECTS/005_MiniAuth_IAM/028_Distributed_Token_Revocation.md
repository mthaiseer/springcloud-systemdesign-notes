...
# MiniAuth / IAM Phase 28 — Distributed Token Revocation
...
```text
Revoke tokens across many nodes using shared store/pub-sub.
```
...
```text
Revocation must reach all nodes.
```
...
```text
DistributedRevocationService
```

Core flow:

```text
shared blacklist/pub-sub
```
...
public class Phase028Driver {
    public static void main(String[] args) {
        ...
        String id = component.create("client-or-user", "Distributed Token Revocation");
...
```bash
java -cp out com.miniauth.driver.Phase028Driver
```
