...
```text
Authenticate users by email and password using the stored password hash.
```
...
```text
Users can register but cannot login.
```
...
```text
email + password -> authenticated principal
```
...
```text
HashMap lookup, hash verification
```
