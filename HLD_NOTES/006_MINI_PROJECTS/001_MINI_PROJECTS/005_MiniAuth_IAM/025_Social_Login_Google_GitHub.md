...
# MiniAuth / IAM Phase 25 — Social Login Google GitHub
...
```text
Model social login using external identity providers.
```
...
```text
external provider profile -> local user
```
...
public class Phase025Driver {
    public static void main(String[] args) {
        ...
        String id = component.create("client-or-user", "Social Login Google GitHub");
...
```bash
java -cp out com.miniauth.driver.Phase025Driver
```
