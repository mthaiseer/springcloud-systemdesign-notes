...
# MiniAuth / IAM Phase 21 — OAuth2 Authorization Code
...
```text
Support browser-based authorization code flow.
```
...
```text
Browser apps need delegated user login.
```
...
public class Phase021Driver {
    public static void main(String[] args) {
        ...
        String id = component.create("client-or-user", "OAuth2 Authorization Code");
...
```bash
java -cp out com.miniauth.driver.Phase021Driver
```
