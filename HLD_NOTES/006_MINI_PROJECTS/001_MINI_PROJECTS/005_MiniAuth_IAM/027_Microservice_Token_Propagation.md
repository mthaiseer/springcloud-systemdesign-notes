...
# MiniAuth / IAM Phase 27 — Microservice Token Propagation
...
```text
Propagate user identity and scopes across internal services.
```
...
```text
Internal services need user context.
```
...
```text
verified identity -> downstream headers
```
...
public class Phase027Driver {
    public static void main(String[] args) {
        ...
        String id = component.create("client-or-user", "Microservice Token Propagation");
...
```bash
java -cp out com.miniauth.driver.Phase027Driver
```
