...
# MiniAuth / IAM Phase 10 — API Key Authentication
...
```text
Authenticate machine-to-machine clients using API keys.
```
...
public class Phase010Driver {
    public static void main(String[] args) {
        ...
        String id = component.create("client-or-user", "API Key Authentication");
