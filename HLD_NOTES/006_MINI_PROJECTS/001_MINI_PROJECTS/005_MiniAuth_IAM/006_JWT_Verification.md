...
# MiniAuth / IAM Phase 6 — JWT Verification
...
```text
Verify JWT signature, expiry, issuer, subject, and claims before API access.
```
...
```text
JWT can be generated but not trusted on APIs.
```
