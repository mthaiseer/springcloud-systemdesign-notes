...
# MiniAuth / IAM Phase 35 — SAML Basics
...
```text
Understand SAML identity federation basics.
```
...
public class Phase035Driver {
    public static void main(String[] args) {
        ...
        String id = component.create("client-or-user", "SAML Basics");
...
```bash
java -cp out com.miniauth.driver.Phase035Driver
```
