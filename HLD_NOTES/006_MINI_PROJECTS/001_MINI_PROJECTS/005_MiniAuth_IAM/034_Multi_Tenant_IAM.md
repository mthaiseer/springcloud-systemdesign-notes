...
# MiniAuth / IAM Phase 34 — Multi Tenant IAM
...
```text
Add tenant isolation for SaaS-style IAM.
```
...
```text
All users are in one global namespace.
```
...
public class Phase034Driver {
    public static void main(String[] args) {
        ...
        String id = component.create("client-or-user", "Multi Tenant IAM");
...
```bash
java -cp out com.miniauth.driver.Phase034Driver
```
