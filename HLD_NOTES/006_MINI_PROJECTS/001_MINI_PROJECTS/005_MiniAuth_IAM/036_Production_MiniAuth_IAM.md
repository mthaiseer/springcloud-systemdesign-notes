...
# MiniAuth / IAM Phase 36 — Production MiniAuth IAM
...
public class Phase036Driver {
    public static void main(String[] args) {
        IdentityComponent component = new IdentityComponent();

        String id = component.create("client-or-user", "Production MiniAuth IAM");
...
```bash
java -cp out com.miniauth.driver.Phase036Driver
```
