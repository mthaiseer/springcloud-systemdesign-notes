...
# MiniAuth / IAM Phase 14 — Refresh Token Rotation
...
```text
Rotate refresh tokens and detect replay attacks.
```
...
```text
Refresh token reuse cannot be detected.
```
