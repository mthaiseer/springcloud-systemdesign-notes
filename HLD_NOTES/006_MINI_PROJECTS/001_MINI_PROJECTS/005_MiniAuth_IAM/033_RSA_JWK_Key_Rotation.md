...
# MiniAuth / IAM Phase 33 — RSA JWK Key Rotation
...
```text
RSA JWK Key Rotation
```

Purpose:

```text
Sign JWTs with rotating RSA keys and expose JWK metadata.
```
...
```bash
java -cp out com.miniauth.driver.Phase033Driver
```
