...
# MiniAuth / IAM Phase 22 — OAuth2 PKCE
...
```text
Add PKCE protection for public clients.
```
...
```text
Public clients cannot protect client secret.
```
...
public class Phase022Driver {
    public static void main(String[] args) {
        ...
        String id = component.create("client-or-user", "OAuth2 PKCE");
...
```bash
java -cp out com.miniauth.driver.Phase022Driver
```
