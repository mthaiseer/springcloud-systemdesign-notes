...
# MiniAuth / IAM Phase 7 — JWT Expiration And Refresh Token
...
```text
JWT Expiration And Refresh Token
```

Purpose:

```text
Add short-lived access tokens and long-lived refresh tokens.
```
...
```text
Access token lifetime is not managed well.
```
