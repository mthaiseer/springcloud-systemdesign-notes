...
# MiniAuth / IAM Phase 31 — Concurrent Session Control
...
```text
Limit active sessions per user/device.
```
...
```bash
java -cp out com.miniauth.driver.Phase031Driver
```
