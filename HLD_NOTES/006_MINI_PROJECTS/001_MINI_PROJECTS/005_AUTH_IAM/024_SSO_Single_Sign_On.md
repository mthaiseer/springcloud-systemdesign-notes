...
# MiniAuth / IAM Phase 24 — SSO Single Sign On
...
```text
Add centralized login across multiple applications.
```
...
```text
central login session -> app sessions
```
...
public class Phase024Driver {
    public static void main(String[] args) {
        ...
        String id = component.create("client-or-user", "SSO Single Sign On");
...
```bash
java -cp out com.miniauth.driver.Phase024Driver
```
