...
# MiniAuth / IAM Phase 20 — OAuth2 Client Credentials
...
```text
Support service-to-service OAuth2 client credentials grant.
```
...
public class Phase020Driver {
    public static void main(String[] args) {
        ...
        String id = component.create("client-or-user", "OAuth2 Client Credentials");
...
```bash
java -cp out com.miniauth.driver.Phase020Driver
```
