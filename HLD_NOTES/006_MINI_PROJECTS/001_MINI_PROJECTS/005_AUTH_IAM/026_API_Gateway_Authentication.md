...
# MiniAuth / IAM Phase 26 — API Gateway Authentication
...
```text
Verify tokens at gateway before requests reach services.
```
...
```text
Each service validates auth itself.
```
...
```text
gateway verifies token before routing
```
...
public class Phase026Driver {
    public static void main(String[] args) {
        ...
        String id = component.create("client-or-user", "API Gateway Authentication");
...
```bash
java -cp out com.miniauth.driver.Phase026Driver
```
