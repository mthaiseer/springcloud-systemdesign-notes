...
# MiniAuth / IAM Phase 18 — Password Reset Flow
...
```text
Implement secure forgot-password reset tokens and reset confirmation.
```
...
```text
Forgotten password cannot be recovered safely.
```
