...
# MiniAuth / IAM Phase 16 — Two Factor Authentication
...
```text
Add second-factor challenge after password login.
```
...
```text
password success -> second challenge
```
