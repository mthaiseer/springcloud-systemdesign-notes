...
# MiniRedis Phase 010 — Recover From AOF
...
Rebuild memory by replaying AOF after restart.
...
We add startup recovery by parsing and executing log lines.
...
/*
Logic before class:
Driver proves phase 010 behavior without telnet or external tools.
*/
...
java -cp out com.miniredis.phase010.Phase010Driver
```
...
```text
Input operation for Recover From AOF
```
...
After : new Recover From AOF behavior available
```
