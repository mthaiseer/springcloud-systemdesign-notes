...
# MiniRedis Phase 030 — Load Testing With k6
...
Benchmark MiniRedis under load.
...
We add k6 scripts and bottleneck analysis checklist.
...
java -cp out com.miniredis.phase030.Phase030Driver
```
...
```text
Input operation for Load Testing With k6
```
...
After : new Load Testing With k6 behavior available
```
