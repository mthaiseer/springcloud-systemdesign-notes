...
# MiniRedis Phase 011 — Multi Client Server
...
We add thread-per-client handling.
...
/*
Logic before class:
Driver proves phase 011 behavior without telnet or external tools.
*/
...
java -cp out com.miniredis.phase011.Phase011Driver
```
...
```text
Input operation for Multi Client Server
```
...
After : new Multi Client Server behavior available
```
