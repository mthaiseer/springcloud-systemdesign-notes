...
Parse Redis-like commands from text/RESP-style input.
...
Echo server only repeats input.
...
We add Command object, parser, response writer, and parser driver.
...
```text
String parsing, tokenization, protocol framing
```
...
/*
Logic before class:
Driver proves phase 002 behavior without telnet or external tools.
*/
...
java -cp out com.miniredis.phase002.Phase002Driver
```
...
```text
Input operation for RESP Protocol Parser
```
...
After : new RESP Protocol Parser behavior available
```
