...
We add channel subscriber registry and publish fanout.
...
java -cp out com.miniredis.phase019.Phase019Driver
```
...
After : new Pub Sub behavior available
```
