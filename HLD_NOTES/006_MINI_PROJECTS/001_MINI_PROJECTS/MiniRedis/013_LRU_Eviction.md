...
# MiniRedis Phase 013 — LRU Eviction
...
Evict least recently used keys under capacity.
...
We add LinkedHashMap/access-order LRU policy.
...
java -cp out com.miniredis.phase013.Phase013Driver
```
...
```text
Input operation for LRU Eviction
```
...
After : new LRU Eviction behavior available
```
