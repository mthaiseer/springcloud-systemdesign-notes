...
# MiniRedis Phase 024 — Distributed Sharding
...
Hash ring exists but no cluster routing.
...
We add ClusterClient that routes commands by key.
...
java -cp out com.miniredis.phase024.Phase024Driver
```
...
```text
Input operation for Distributed Sharding
```
...
After : new Distributed Sharding behavior available
```
