...
# MiniRedis Phase 021 — Master Replica
...
Replicate write commands to follower node.
...
We add master forwarding writes to replica.
...
java -cp out com.miniredis.phase021.Phase021Driver
```
...
```text
Input operation for Master Replica
```
...
After : new Master Replica behavior available
```
