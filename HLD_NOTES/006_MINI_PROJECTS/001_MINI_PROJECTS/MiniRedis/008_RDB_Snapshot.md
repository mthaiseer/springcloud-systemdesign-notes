...
# MiniRedis Phase 008 — RDB Snapshot
...
Persist current memory state to disk snapshot.
...
We add snapshot save/load using Java serialization/text format.
...
/*
Logic before class:
Driver proves phase 008 behavior without telnet or external tools.
*/
...
java -cp out com.miniredis.phase008.Phase008Driver
```
...
```text
Input operation for RDB Snapshot
```
...
After : new RDB Snapshot behavior available
```
