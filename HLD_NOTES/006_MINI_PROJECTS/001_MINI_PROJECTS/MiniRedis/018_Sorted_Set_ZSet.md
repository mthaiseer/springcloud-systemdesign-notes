...
# MiniRedis Phase 018 — Sorted Set ZSet
...
We add ZADD and ZRANGE using TreeMap/simple sorted structure.
...
```text
Balanced tree, skip-list concept
```
...
java -cp out com.miniredis.phase018.Phase018Driver
```
...
```text
Input operation for Sorted Set ZSet
```
...
After : new Sorted Set ZSet behavior available
```
