...
# MiniRedis Phase 005 — TTL Expiration
...
Add expiring keys using EX seconds and TTL command.
...
We wrap values in ValueEntry with expireAtMillis and lazy expiration.
...
```text
Timestamp comparison, lazy deletion
```
...
/*
Logic before class:
Driver proves phase 005 behavior without telnet or external tools.
*/
...
java -cp out com.miniredis.phase005.Phase005Driver
```
...
```text
Input operation for TTL Expiration
```
...
After : new TTL Expiration behavior available
```
