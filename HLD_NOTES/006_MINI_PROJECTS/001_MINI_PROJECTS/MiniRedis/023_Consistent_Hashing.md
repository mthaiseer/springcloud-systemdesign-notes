...
# MiniRedis Phase 023 — Consistent Hashing
...
Naive modulo causes massive remap.
...
We add virtual nodes and ring lookup.
...
java -cp out com.miniredis.phase023.Phase023Driver
```
...
```text
Input operation for Consistent Hashing
```
...
After : new Consistent Hashing behavior available
```
