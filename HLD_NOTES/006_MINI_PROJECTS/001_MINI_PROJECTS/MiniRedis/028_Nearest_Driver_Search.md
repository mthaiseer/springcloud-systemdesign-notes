...
# MiniRedis Phase 028 — Nearest Driver Search
...
Build Uber-style nearest driver lookup.
...
GeoHash exists but no product scenario.
...
We add driver location updates and nearest search flow.
...
java -cp out com.miniredis.phase028.Phase028Driver
```
...
```text
Input operation for Nearest Driver Search
```
...
After : new Nearest Driver Search behavior available
```
