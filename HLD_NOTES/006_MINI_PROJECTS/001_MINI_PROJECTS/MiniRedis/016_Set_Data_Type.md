...
# MiniRedis Phase 016 — Set Data Type
...
We add SADD, SREM, SISMEMBER, SMEMBERS.
...
java -cp out com.miniredis.phase016.Phase016Driver
```
...
```text
Input operation for Set Data Type
```
...
After : new Set Data Type behavior available
```
