...
# MiniRedis Phase 015 — List Data Type
...
We add LPUSH, RPUSH, LPOP, RPOP using Deque.
...
java -cp out com.miniredis.phase015.Phase015Driver
```
...
```text
Input operation for List Data Type
```
...
After : new List Data Type behavior available
```
