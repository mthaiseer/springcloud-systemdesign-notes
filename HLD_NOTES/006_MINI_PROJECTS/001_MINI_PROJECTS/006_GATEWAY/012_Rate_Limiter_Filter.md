...
# MiniGateway Phase 12 — Rate Limiter Filter
...
```bash
java -cp out com.minigateway.driver.Phase012Driver
```
...
```text
Client sends request related to: Rate Limiter Filter
```
...
3. Gateway applies RateLimiterFilter.
