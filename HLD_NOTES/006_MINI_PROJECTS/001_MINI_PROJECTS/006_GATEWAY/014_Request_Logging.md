...
# MiniGateway Phase 14 — Request Logging
...
```bash
java -cp out com.minigateway.driver.Phase014Driver
```
...
```text
Client sends request related to: Request Logging
```
...
3. Gateway applies RequestLogger.
