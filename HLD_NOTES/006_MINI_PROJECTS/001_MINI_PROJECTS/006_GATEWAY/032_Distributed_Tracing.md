...
# MiniGateway Phase 32 — Distributed Tracing
...
```text
Propagate trace/span IDs across services.
```
...
```bash
java -cp out com.minigateway.driver.Phase032Driver
```
...
```text
Client sends request related to: Distributed Tracing
```
...
3. Gateway applies DistributedTracingFilter.
