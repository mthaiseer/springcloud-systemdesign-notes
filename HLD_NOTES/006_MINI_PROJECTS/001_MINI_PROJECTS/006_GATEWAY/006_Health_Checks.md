...
# MiniGateway Phase 6 — Health Checks
...
```text
Continuously check backend health and avoid routing to unhealthy instances.
```
...
```text
Gateway can route to dead instances.
```
...
```bash
java -cp out com.minigateway.driver.Phase006Driver
```
...
```text
Client sends request related to: Health Checks
```
...
3. Gateway applies HealthChecker.
