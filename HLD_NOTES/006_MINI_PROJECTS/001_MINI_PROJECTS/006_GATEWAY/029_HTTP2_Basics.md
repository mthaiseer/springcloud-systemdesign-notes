...
# MiniGateway Phase 29 — HTTP2 Basics
...
```text
Understand multiplexing and connection reuse concepts.
```
...
```text
HTTP/1.1 connection model is limited.
```
...
```bash
java -cp out com.minigateway.driver.Phase029Driver
```
...
```text
Client sends request related to: HTTP2 Basics
```
...
3. Gateway applies Http2Concept.
