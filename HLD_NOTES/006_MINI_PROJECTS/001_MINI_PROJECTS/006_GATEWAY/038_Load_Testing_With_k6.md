...
# MiniGateway Phase 38 — Load Testing With k6
...
```text
Benchmark gateway throughput and latency.
```
...
```bash
java -cp out com.minigateway.driver.Phase038Driver
```
...
```text
Client sends request related to: Load Testing With k6
```
