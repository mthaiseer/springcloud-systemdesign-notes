...
# MiniGateway Phase 19 — Request Validation
...
```text
Validate method, headers, body size, and required fields.
```
...
```text
Invalid traffic reaches backend.
```
...
```text
method/header/body size validation
```
...
```bash
java -cp out com.minigateway.driver.Phase019Driver
```
...
```text
Client sends request related to: Request Validation
```
...
3. Gateway applies ValidationFilter.
