...
# MiniGateway Phase 28 — WebSocket Proxy
...
```text
Only request/response HTTP supported.
```
...
```bash
java -cp out com.minigateway.driver.Phase028Driver
```
...
```text
Client sends request related to: WebSocket Proxy
```
...
3. Gateway applies WebSocketProxy.
