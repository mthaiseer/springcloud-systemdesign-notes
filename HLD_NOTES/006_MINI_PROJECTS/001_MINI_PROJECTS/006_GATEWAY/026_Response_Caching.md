...
# MiniGateway Phase 26 — Response Caching
...
```bash
java -cp out com.minigateway.driver.Phase026Driver
```
...
```text
Client sends request related to: Response Caching
```
...
3. Gateway applies ResponseCache.
