...
# MiniGateway Phase 22 — Retry Filter
...
```text
Retry safe failed requests with controlled policy.
```
...
```bash
java -cp out com.minigateway.driver.Phase022Driver
```
...
```text
Client sends request related to: Retry Filter
```
