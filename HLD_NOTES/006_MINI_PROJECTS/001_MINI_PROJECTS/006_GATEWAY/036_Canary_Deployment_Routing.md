...
# MiniGateway Phase 36 — Canary Deployment Routing
...
```text
New version receives all traffic at once.
```
...
```bash
java -cp out com.minigateway.driver.Phase036Driver
```
...
```text
Client sends request related to: Canary Deployment Routing
```
...
3. Gateway applies CanaryRouter.
