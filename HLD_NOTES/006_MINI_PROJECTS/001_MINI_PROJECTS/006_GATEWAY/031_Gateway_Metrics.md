...
# MiniGateway Phase 31 — Gateway Metrics
...
```text
Expose metrics for requests, latency, errors, and backend health.
```
...
```bash
java -cp out com.minigateway.driver.Phase031Driver
```
...
```text
Client sends request related to: Gateway Metrics
```
...
3. Gateway applies MetricsRegistry.
