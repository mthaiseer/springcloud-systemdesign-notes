...
# MiniGateway Phase 18 — CORS Filter
...
```text
Handle cross-origin browser requests.
```
...
```text
Browser cross-origin calls fail.
```
...
```bash
java -cp out com.minigateway.driver.Phase018Driver
```
...
```text
Client sends request related to: CORS Filter
```
