...
# MiniGateway Phase 27 — GZip Compression
...
```text
Compress large text responses before sending to clients.
```
...
```text
Large text responses waste bandwidth.
```
...
```bash
java -cp out com.minigateway.driver.Phase027Driver
```
...
```text
Client sends request related to: GZip Compression
```
...
3. Gateway applies CompressionFilter.
