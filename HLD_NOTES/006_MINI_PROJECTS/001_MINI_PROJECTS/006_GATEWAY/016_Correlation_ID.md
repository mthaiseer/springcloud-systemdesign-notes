...
# MiniGateway Phase 16 — Correlation ID
...
```text
Attach correlation IDs to requests and logs.
```
...
```bash
java -cp out com.minigateway.driver.Phase016Driver
```
...
```text
Client sends request related to: Correlation ID
```
...
3. Gateway applies CorrelationIdFilter.
