# 016_Redis_GEO_Style_Commands.md

# MiniGeo Phase 16 — Redis GEO Style Commands
...
```text
Redis GEO Style Commands
```

Purpose:

```text
Model Redis GEO operations.
```
