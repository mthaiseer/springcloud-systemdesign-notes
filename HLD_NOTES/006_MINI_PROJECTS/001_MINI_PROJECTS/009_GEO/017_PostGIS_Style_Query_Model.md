# 017_PostGIS_Style_Query_Model.md

# MiniGeo Phase 17 — PostGIS Style Query Model
...
```text
PostGIS Style Query Model
```

Purpose:

```text
Model spatial SQL queries.
```
...
```text
018_Elasticsearch_Geo_Query_Model.md
```
