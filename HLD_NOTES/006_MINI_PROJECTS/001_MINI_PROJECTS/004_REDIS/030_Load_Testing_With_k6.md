...
# MiniRedis Phase 30 — Load Testing With k6
...
```text
Benchmark MiniRedis with k6 and analyze bottlenecks.
```
...
```text
There was no proof of throughput or latency behavior.
```
...
```text
We add k6 test script, test scenarios, and bottleneck checklist.
```
...
```bash
java -cp out com.miniredis.driver.Phase030Driver
```
...
```text
Load generation, latency percentiles, throughput analysis
```
...
```text
capacity planning, performance tuning, production readiness
```
