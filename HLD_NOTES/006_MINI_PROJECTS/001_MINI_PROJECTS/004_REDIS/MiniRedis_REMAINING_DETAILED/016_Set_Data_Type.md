...
# MiniRedis Phase 16 — Set Data Type
...
```text
Add Redis Set commands for unique membership.
```
...
```text
There was no data structure for unique members.
```
...
```text
We add SADD, SREM, SISMEMBER, and SMEMBERS.
```
...
```bash
java -cp out com.miniredis.driver.Phase016Driver
```
...
```text
HashSet, membership test, uniqueness
```
...
```text
unique visitors, followers, permissions, tags
```
