# 030_Consul_Eureka_ZooKeeper_Comparison.md

# MiniServiceDiscovery Phase 30 — Consul Eureka ZooKeeper Comparison
...
```text
Consul Eureka ZooKeeper Comparison
```

Purpose:

```text
Compare real systems.
```
