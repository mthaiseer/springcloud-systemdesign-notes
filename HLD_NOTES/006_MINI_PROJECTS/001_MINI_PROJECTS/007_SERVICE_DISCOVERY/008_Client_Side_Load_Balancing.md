# 008_Client_Side_Load_Balancing.md

# MiniServiceDiscovery Phase 8 — Client Side Load Balancing
...
```text
Clients choose backend instance themselves.
```
