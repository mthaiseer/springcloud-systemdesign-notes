# 009_Round_Robin_Discovery_Client.md

# MiniServiceDiscovery Phase 9 — Round Robin Discovery Client
...
```text
Round Robin Discovery Client
```

Purpose:

```text
Rotate requests across instances.
```
...
```text
010_Least_Connections_Discovery_Client.md
```
