...
# MiniServiceDiscovery Phase 2 — Service Instance Model
...
```text
Add metadata, health status, version, zone, and timestamps.
```
...
```text
003_Register_Service_Instance.md
```
