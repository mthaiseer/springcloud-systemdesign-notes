# 021_Leader_Election_For_Registry.md

# MiniServiceDiscovery Phase 21 — Leader Election For Registry
...
```text
Leader Election For Registry
```

Purpose:

```text
Elect leader registry node.
```
