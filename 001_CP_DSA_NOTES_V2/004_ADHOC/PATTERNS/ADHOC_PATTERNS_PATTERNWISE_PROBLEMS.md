...
- [Form 1 — Sort + Rearrange / Pairing](#form-1-sort-rearrange-pairing)
- [Form 2 — Sort + Greedy Cheapest First](#form-2-sort-greedy-cheapest-first)
- [Form 3 — Median / Absolute Difference](#form-3-median-absolute-difference)
- [Form 4 — Reachable Range / Missing Value](#form-4-reachable-range-missing-value)
- [Form 5 — Modulo Extremum](#form-5-modulo-extremum)
- [Form 6 — Periodicity / Modulo Cycle](#form-6-periodicity-modulo-cycle)

### LEVEL 2 — Operation Reasoning
- [Form 7 — Operation Effect / Divisibility](#form-7-operation-effect-divisibility)
- [Form 8 — Boundary / Corner Observation](#form-8-boundary-corner-observation)
- [Form 9 — Invariant](#form-9-invariant)
- [Form 10 — Necessary + Sufficient Condition](#form-10-necessary-sufficient-condition)
- [Form 11 — Small Candidate Set / Bounded Simulation](#form-11-small-candidate-set-bounded-simulation)

### LEVEL 3 — Constructive Ad-hoc
- [Form 12 — Construct Valid Answer](#form-12-construct-valid-answer)
- [Form 13 — Repair Invalid Local State](#form-13-repair-invalid-local-state)
- [Form 14 — Two-Ends Construction](#form-14-two-ends-construction)
- [Form 15 — Binary / String Construction](#form-15-binary-string-construction)
